<div class="wrapper">
  <div id="featured_slide" class="clear">
    ...
    <ul id="featured_tabs">
      <li><a href="#fc1">All About The River Basins</a></li>
      <li><a href="#fc2">Development Projects</a></li>
      <li><a href="#fc3">Irrigation and Land use</a></li>
      <li><a href="#fc4">Roads and Transport</a></li>
      <li class="last"><a href="#fc5">Celebrations &amp; Events</a></li>
    </ul>
    ...
    <div id="container" class="clear">
      ...
      <div id="homepage" class="clear">
        ...
        <div id="left_column">
          ...
          <div class="imgholder">  <a href="#"><img src="images/demo/logo.gif" width="220" height="230"/></a></div>
           <p>This website gives you complete information of the River Basins of Kerala state. this information will be helpful in planning and development of the River basin and watersheds  </p>
          ...
          <ul>
            <li class="clear">
              ...
              <div class="latestnews">
                <p><a href="#">No timeline set for sorting out issues on Western Ghat report</a></p>
        ...
        <!--    <li class="last clear">
              ...
              <div class="latestnews">
                <p><a href="#">Kerala Beautiful Waterfalls </a></p>
                <p>The Athirapally Falls situated near Kochi, are rightly called the Niagra of India.Situated around 55km northeast of the Kochi Airport. </p>
              </div>
            </li>
         --> </ul>
