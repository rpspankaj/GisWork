  ...
  <div class="rnd">
    <div id="footer" class="clear">
      ...
      <div class="fl_left clear">
        <div class="fl_left center"><img src="images/demo/KSREC-Logo.png" alt="" /><br />
       </div>
        <address>
        Vikas Bhavan<br />
...
<div class="wrapper col5">
		<div id="copyright">
			<p class="fl_left">
				Copyright &copy; 2014 - All Rights Reserved - <a href="#">KSRSEC
					Vikas Bhavan, Thiruvananthapuram</a>
			</p>
			<p class="fl_right">
				Designed by <a href="#" title="Sport information system">Ashish Kumar Gautam</a>
			</p>
			<br class="clear" />
		</div>
	</div>
