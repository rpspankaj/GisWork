	...
	<p>Vikash Bhavan,Thiruvananthapuram-33</p>	
	       ...
	       <div id="column">
        	...
        	<h2><font color=#02ACEE> Adding Shape files</font></h2>
					<img src="images/demo/logo.gif" width="240" height="240">
			
					<p><a href="#" ><input name="addshape" type="button" id="addshape" value="ADD SHAPEFILES" tabindex="5" disabled="disabled"></a></p>
